...
local choices = menu.choices({
	{ name = "125%",              value = app .. " --output " .. display .. " --scale 1.25" },
	{ name = "115%",              value = app .. " --output " .. display .. " --scale 1.15" },
	{ name = "100%",              value = app .. " --output " .. display .. " --scale 1" },
	{ name = "85%",               value = app .. " --output " .. display .. " --scale 0.85" },
	{ name = "75%",               value = app .. " --output " .. display .. " --scale 0.75" },
	{ name = "--------------------------------------" },
