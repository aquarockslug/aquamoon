...
# PROMPT="%(?:%F{${catppuccin_teal}}%1{➜%} :%F{${catppuccin_red}}%1{➜%} )"
PROMPT="%(?:%F{${catppuccin_teal}}%1{󰈿%} :%F{${catppuccin_red}}%1{󰈿%} )"
...
PROMPT+="%F{${catppuccin_teal}}%c%{$reset_color%} "
PROMPT+="%F{${catppuccin_mauve}}% "
