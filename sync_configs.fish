...
function color_reset; printf '\033[0m'; end
function color_header; printf '\033[1;36m'; end
function color_success; printf '\033[32m'; end
function color_error; printf '\033[31m'; end
function color_warning; printf '\033[33m'; end
function color_info; printf '\033[34m'; end
function color_file; printf '\033[35m'; end

function sync_files
    argparse 's/src-dir=' 'd/dst-dir=' -- $argv; or return 1
