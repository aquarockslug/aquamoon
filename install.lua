...
local packages = {
	...
	"ddgr", "duf", "dunst", "dust", "eza", "fastfetch", "firefox",
	"gimp", "git", "github-cli", "grim", "gtklock", "htop", "lazygit",
	"loupe", "lua", "lua-language-server", "luarocks", "man-db",
	"neovide", "networkmanager", "networkmanager-dmenu", "nwg-look",
	"pamixer", "peco", "ripgrep", "river",
	"river-luatile-git", "rust", "scooter-bin", "showtime",
...
local optional = {
	"opencode-bin", "openoffice-bin", "qbittorrent", "pandoc-cli", "youtui",
	"qutebrowser", "luakit", "godot3", "smassh", "ttf-liberation-mono-nerd"
}
...
if exec("sudo mkdir -p /usr/share/lua/5.4/lib /usr/share/luajit-2.1/lib") then
...
print(colors.blue ..
	"ℹ Please restart your shell or run 'source ~/.config/fish/config.fish' to apply changes." .. colors.reset)
